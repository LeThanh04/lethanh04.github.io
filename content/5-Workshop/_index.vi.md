...
![AWS BILLO System Architecture](/LTPT-fcj-workshop/static/images/5-Workshop/5.1-Workshop-overview)
...
### [5.9 - Tổng quan dự án](5.9-Project-Overview/)

Phần này trình bày các tính năng chính của AWS BILLO cho từng vai trò người dùng (Khách hàng, Người bán và Quản trị viên), bao gồm ảnh chụp màn hình và hướng dẫn từng bước cho mỗi tính năng. Thông tin chi tiết bổ sung được cung cấp trong Phần 5.9.1, 5.9.2 và 5.9.3.
---
